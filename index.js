...
/*Remembered I shouldnt use backticks and dollarsigns so ill comment this out
...
//print out the chosen price
console.log("Chosen price: $" + price);
//Reduce the price by 10 procent
let discountPrice = price - (price * 0.10);
//print the calculation of discount price
console.log("Discount: " + price + " - (" + price + " * 0.10) = " + (price - price * 0.10));
// Print out the new price using console.log(), for example: 'New price: $44.99'
console.log("New price: $" + discountPrice);
*/
